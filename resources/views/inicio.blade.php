<x-app-layout>
  ...
  <!-- Características Carro -->
  <div class="flex flex-col md:flex-row w-full bg-black text-white">
      <!-- Contenido a la derecha -->
      <div class="w-full md:w-3/5 flex flex-col justify-center px-6 md:px-16 py-10">
          <h2 class="text-3xl md:text-4xl font-bold mb-6 text-center md:text-left">Nuestra Tecnología</h2>
          <p class="text-base md:text-lg mb-8 text-center md:text-left">
              En Bison, nos esforzamos por mantenernos a la vanguardia de la innovación tecnológica...
          </p>
      ...
      <div class="w-full md:w-2/5 flex items-center justify-center md:justify-end py-6 md:py-0">
          <img class="w-auto h-64 md:h-full object-contain" src="{{ asset('images/arduino.png') }}" alt="Imagen grande">
      </div>
  </div>
