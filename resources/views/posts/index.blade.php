<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-white bg-black dark:text-gray-200 leading-tight">
            BISON BLOG
        </h2>
    </x-slot>
...
{{-- -Aquí empieza el form post --}}
            <!-- Card de bienvenida -->
            <div class="mb-6 p-6 bg-white  text-black rounded-lg shadow-lg">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-black-900 dark:text-black-100">
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <x-primary-button class="mt-6 w-full bg-black hover:bg-green-500 text-white py-2 rounded-md">
                            {{ __('Publicar') }}
                        </x-primary-button>
                    </form>
                </div>
